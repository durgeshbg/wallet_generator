export default function ChainNav({ setChain, chains, chain }) {
  return (
    <div className='flex flex-col'>
      <h2 className='text-center text-2xl mb-4 text-white'>Chains</h2>
      <div className='w-full flex text-white items-center justify-around x5 h-fit max-w-lg rounded-full backdrop-blur-sm bg-white/15 border-none mx-auto p-2'>
        <button
          className={
